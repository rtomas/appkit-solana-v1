...
return (
    <div className="App center-content">
      ...
      <div className="circle">
        <a href="https://github.com/WalletConnect/web-examples/tree/feat/web3modal-solana-example/dapps/web3modal/react-solana" target="_blank"><img src="/github.png" alt="GitHub" width="50" /></a>
      </div>
    </div>
  );
}
